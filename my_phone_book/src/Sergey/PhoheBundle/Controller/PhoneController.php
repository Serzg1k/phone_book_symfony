...
use Sergey\PhoheBundle\Entity\Phone;
...
class PhoneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $phones = $em->getRepository('SergeyPhoheBundle:Phone')->findAll();
    ...
    {
        $phone = new Phone();
        $form = $this->createForm('Sergey\PhoheBundle\Form\PhoneType', $phone);
    ...
    {
        $deleteForm = $this->createDeleteForm($phone);
        $editForm = $this->createForm('Sergey\PhoheBundle\Form\PhoneType', $phone);
